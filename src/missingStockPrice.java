...
public class missingStockPrice {
	...
	public static void main(String[] args) throws ParseException, FileNotFoundException{
		...
		Scanner scanner=new Scanner(new FileReader(filePath + "/src/stocks3.txt"));
	...
	public static ArrayList<Integer> getNeighbours(int missing_index){
		...
		int neighbours_needed=4;
		int index_range=1;
		boolean index_range_found=false;
		
		System.out.println("for missing_index:"+missing_index);
		while (!index_range_found)
		{
			...
			if(neighbours_count >= neighbours_needed){
